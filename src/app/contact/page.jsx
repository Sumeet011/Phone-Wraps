      ...
      <div className="font-sans ">
        ...
        <section className="bg-[#090701] text-white -mt-10 py-10 px-4 sm:px-6 md:px-10 lg:px-20 xl:px-36 flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="w-full  md:w-2/3">
            ...
            <h2 className={` ${JersyFont.className} text-[#9AE600] text-xl min-[240px]:text-3xl  font-semibold mb-6 leading-snug`}>
          ...
          {/* Right: Info Box */}
          <div className="bg-lime-400 rounded-lg p-6 text-black w-full lg:w-1/3 mt-18 relative transform hover:rotate-6 transition-transform duration-500">
